    ...
    public function collection()
    {
        ...
        foreach ($this->query as $key => $statement) {
            ...
            $transactions[] = [
                ...
                'System Date' => Carbon::createFromTimestamp($statement->date_received, config('app.timezone'))->format('d-m-Y'),
                'Bank Date' => $statement->bank_date ? Carbon::createFromTimestamp($statement->bank_date, config('app.timezone'))->format('d-m-Y') : null,
            ];
