...
class ExportInvoices Implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    ...
    public function collection()
    {
        ...
        foreach ($this->invoices as $key => $invoice) {
            $invDate = Carbon::createFromTimestamp($invoice['date_invoiced'], config('app.timezone'))->format('Y-m-d');
            ...
            $inv[] = [
                ...
                'INVOICE DATE' => Carbon::createFromTimestamp($invoice['date_invoiced'], config('app.timezone'))->format('d-m-Y'),
