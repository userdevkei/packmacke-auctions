...
//            'setAutoTopMargin' => 'stretch',
    ...
    public function arrivalDate($id)
    {
        ...
        return Carbon::createFromTimestamp($stock->date_received, config('app.timezone'))->format('d-m-Y');
    }
...
private function writeBlendHeader($ws, string $lastCol, $sheet, int $startRow): int
{
    ...
    private function writePackingListHeader(
        ...
        $rightValues = [
            ...
            $sheet->ship_date ? Carbon::createFromTimestamp($sheet->ship_date, config('app.timezone'))->format('d/m/Y') : '',
        ];
