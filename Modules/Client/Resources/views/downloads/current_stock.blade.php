...
<table class="table">
    ...
    <tr>
        ...
        <th style="width: 8% !important;">Inv No</th>
        <th style="width: 8% !important;">Garden</th>
        <th style="width: 5% !important;">Grade</th>
        <th style="width: 5% !important;">Sale No</th>
        <th style="width: 5% !important;">Gross</th>
        <th style="width: 5% !important;">Tare</th>
        <th style="width: 5% !important;">Net</th>
        <th style="width: 5% !important;">Pkgs</th>
        <th style="width: 7% !important;">Nt Wght</th>
        <th style="width: 7% !important;">Gr Wght</th>
        <th style="width: 8% !important;">TCI NO</th>
        <th style="width: 6% !important;">DO. NO</th>
        <th style="width: 7% !important;">Date Rcvd</th>
        <th style="width: 18% !important;">Producer Whs</th>
        <th style="width: 8% !important;">Aging Date</th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    @foreach($orders as $order)
        <tr>
            ...
            <td>{{ \Carbon\Carbon::createFromTimestamp($order->date_received, config('app.timezone'))->format('d-m-y') }}</td>
