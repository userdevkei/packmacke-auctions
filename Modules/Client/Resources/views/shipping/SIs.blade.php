                    ...
                    <table class="table mb-0 table-bordered table-striped" id="datatable">
                        ...
                        @foreach($shipping as $transfer)
                            <tr>
                                ...
                                <td>{{ number_format($transfer->shipped_packages, 2) }}</td>
                                <td>{{ number_format($transfer->shipped_weight, 2) }}</td>
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="dropdown font-sans-serif position-static" >
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end border py-0">
                                                <div class="py-2">
                                                    <a class="dropdown-item text-info" href="{{ route('client.addShipmentTeas', $transfer->shipping_id) }}">View SI</a>
                                                    <a class="dropdown-item text-primary" href="{{ route('client.downloadSIDocument', $transfer->shipping_id) }}" target="_blank">Download SI</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
