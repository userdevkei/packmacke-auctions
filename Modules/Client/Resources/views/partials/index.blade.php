                    ...
                    <div class="col-xxl-6 col-lg-12">
                        <div class="card h-100">
                            ...
                            <div class="card-header z-1">
                                <h5 class="text-primary">Welcome {{ auth()->user()->username }}! </h5>
                            ...
                            <div class="card-body z-1">
                                <div class="row g-2 h-100 align-items-end">
                                    <div class="col-sm-6 col-md-5">
                                        <div class="d-flex position-relative">
                                            ...
                                            <div class="flex-1"><a class="stretched-link text-800" href="#!">
                                                ...
                                                <p class="mb-0 fs-11 text-500 fs-sm ">{{ ucwords(strtolower(auth()->user()->client->client_name)) }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    {{--<div class="col-sm-6 col-md-5">
                                    ...
                                    <div class="col-sm-6 col-md-5">
                                        <div class="d-flex position-relative">
                                            <div class="icon-item icon-item-sm border rounded-3 shadow-none me-2"><span class="fa-solid fa-envelope text-success"></span></div>
                                            <div class="flex-1"><a class="stretched-link text-800" href="#!">
                                                    <h6 class="mb-0">Email Address</h6>
                                                </a>
                                                <p class="mb-0 fs-11 text-500">{{ auth()->user()->client->email }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-5">
                                        <div class="d-flex position-relative">
                                            <div class="icon-item icon-item-sm border rounded-3 shadow-none me-2"><span class="fa-solid fa-phone text-danger"></span></div>
                                            <div class="flex-1"><a class="stretched-link text-800" href="#!">
                                                    <h6 class="mb-0">Phone Number</h6>
                                                </a>
                                                <p class="mb-0 fs-11 text-500">{{ auth()->user()->client->phone }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="card overflow-hidden" style="min-width: 12rem">
                                        ...
                                        <div class="card-body position-relative">
                                            ...
                                            <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-warning" data-countup='{"endValue":{{ $uncollected->count() }},"decimalPlaces":2}'>0</div><a class="fw-semi-bold fs-10 text-nowrap" href="{{ route('clerk.dashboardReport', base64_encode(1)) }}">view all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="card overflow-hidden" style="min-width: 12rem">
                                        ...
                                        <div class="card-body position-relative">
                                            ...
                                            <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-info" data-countup='{"endValue":{{ $late->count() }},"decimalPlaces":2}'>0</div><a class="fw-semi-bold fs-10 text-nowrap" href="{{ route('clerk.dashboardReport', base64_encode(2)) }}">view all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="card overflow-hidden" style="min-width: 12rem">
                                        ...
                                        <div class="card-body position-relative">
                                            ...
                                            <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-info" data-countup='{"endValue":{{ $noTCI->count() }},"decimalPlaces":2}'>0</div><a class="fw-semi-bold fs-10 text-nowrap" href="{{ route('clerk.dashboardReport', base64_encode(3)) }}">view all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="card overflow-hidden" style="min-width: 12rem">
                                        ...
                                        <div class="card-body position-relative">
                                            ...
                                            <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-info" data-countup='{"endValue":{{ $overstayed->count() }},"decimalPlaces":2}'>0</div><a class="fw-semi-bold fs-10 text-nowrap" href="{{ route('clerk.dashboardReport', base64_encode(4)) }}">view all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="card overflow-hidden" style="min-width: 12rem">
                                        ...
                                        <div class="card-body position-relative">
                                            ...
                                            <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-warning" data-countup='{"endValue":{{ $internal->count() }},"decimalPlaces":2}'>0</div><a class="fw-semi-bold fs-10 text-nowrap" href="{{ route('clerk.dashboardReport', base64_encode(5)) }}">view all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="card overflow-hidden" style="min-width: 12rem">
                                        ...
                                        <div class="card-body position-relative">
                                            ...
                                            <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-info" data-countup='{"endValue":{{ $external->count() }},"decimalPlaces":2}'>0</div><a class="fw-semi-bold fs-10 text-nowrap" href="{{ route('clerk.dashboardReport', base64_encode(6)) }}">view all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="card overflow-hidden" style="min-width: 12rem">
                                        ...
                                        <div class="card-body position-relative">
                                            ...
                                            <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-info" data-countup='{"endValue":{{ $si->count() }},"decimalPlaces":2}'>0</div><a class="fw-semi-bold fs-10 text-nowrap" href="{{ route('clerk.dashboardReport', base64_encode(7)) }}">view all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="card overflow-hidden" style="min-width: 12rem">
                                        ...
                                        <div class="card-body position-relative">
                                            ...
                                            <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-info" data-countup='{"endValue":{{ $blend->count() }},"decimalPlaces":2}'>0</div><a class="fw-semi-bold fs-10 text-nowrap" href="{{ route('clerk.dashboardReport', base64_encode(8)) }}">view all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @foreach($tops as $index => $stock)
                                <div class="d-flex flex-between-center rounded-3 bg-body-tertiary p-3 mb-2">
                                        <h6 class="mb-0 col-6">
                                            ...
                                            @endif
                                            {{ ucwords(strtolower($stock->client_name)) }}</h6>
