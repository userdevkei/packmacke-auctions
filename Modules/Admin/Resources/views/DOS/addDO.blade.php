                    ...
                    <form id="doForm" method="POST" action="{{ route('admin.registerDeliveryOrder') }}">
                        ...
                        <div class="row g-2 needs-validation" novalidate="">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select js-choice" name="tea_id" size="1" data-options='{"removeItemButton":true,"placeholder":true}' required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select js-choice" name="tea_type" size="1" data-options='{"removeItemButton":true,"placeholder":true}'>
