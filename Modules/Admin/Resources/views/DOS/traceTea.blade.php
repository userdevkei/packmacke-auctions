                            ...
                            @if($teaDetails['deliveryOrder'])
                                <div>
                                    <a class="btn btn-sm btn-primary action-btn"
                                       href="{{ route('admin.editDO', $teaDetails['deliveryOrder']->delivery_id) }}">
                                    ...
                                    @if($teaDetails['deliveryOrder']->do_status < 2 || $teaDetails['deliveryOrder']->do_status == null)
                                        <a class="btn btn-sm btn-danger action-btn"
                                           ...
                                           href="{{ route('admin.deleteDeliveryOrder', $teaDetails['deliveryOrder']->delivery_id) }}">
                                    ...
                                    <div class="info-row">
                                        ...
                                        <span class="info-value">
                                            ...
                                            @if($teaDetails['tciDetails'] && $teaDetails['tciDetails']->path)
                                                <a class="link link-danger" href="{{ route('admin.downloadDeliveryNote', base64_encode($teaDetails['tciDetails']->delivery_number)) }}" target="_blank">
                                    ...
                                    <div class="info-row">
                                        ...
                                        <span class="info-value">
                                            ...
                                            @if($teaDetails['directDelivery'] && $teaDetails['directDelivery']->path)
                                                <a class="link link-danger" href="{{ route('admin.downloadDeliveryNote', base64_encode($teaDetails['directDelivery']->delivery_number)) }}" target="_blank">
                                                    <i class="fa fa-file"></i> download
                                                </a>
                                            @endif
                                        </span>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($teaDetails['straightLine'] as $shipment)
                                            ...
                                            <span
                                                ...
                                                {{ $shipment->status }} {{ $shipment->ship_date == null ? '' : \Carbon\Carbon::createFromTimestamp($shipment->ship_date, config('app.timezone'))->format('Y-m-d') }}
                                            </span>
                                                </td>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($teaDetails['stockDetails'] as $stock)
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::createFromTimestamp($stock->date_received, config('app.timezone'))->format('Y-m-d') }}</td>
