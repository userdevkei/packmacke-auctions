                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($transfer->status == 0)
                                        | <a class="link link-danger" onclick="return confirm('Are you sure you want to delete this line from this sale?')" href="{{ route('admin.removeLineFromPrivateSale', $transfer->auction_id) }}"><i class="fa fa-trash-alt"></i> </a>
                                    @endif
                    ...
                    <table class="table mb-0 table-bordered table-striped fs-sm-10" id="datatable">
                        ...
                        @foreach($teas as $transfer)
                            <tr>
                                ...
                                <td>
                                    <div class="fw-semibold">{{ $transfer->warrant_number }}</div>
                                    <div class="text-muted fs-11">Inv: {{ $transfer->invoice_number }}</div>
                                </td>

                                <td>
                                    <div>{{ $transfer->garden_name }}</div>
                                    <div class="text-muted fs-11">{{ $transfer->grade_name }}</div>
                                </td>

                                <td>
                                    <div>{{ number_format($transfer->current_stock, 0) }} pkgs</div>
                                    <div class="text-muted fs-11">{{ number_format($transfer->current_weight, 2) }} kg</div>
                                </td>

                                <td>
                                    <div class="fw-semibold">{{ $transfer->broker_name }}</div>
                                    <div class="text-muted fs-11">{{ $transfer->buyer_name }}</div>
                                </td>
                                ...
                                <td>
                                    <a class="link link-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop{{ $transfer->auction_id }}">
