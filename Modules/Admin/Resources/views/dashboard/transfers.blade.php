                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        @elseif(auth()->user()->role_id == 2)
                                                @if($transfer->status == null || $transfer->status == 0 )
                                                    <a class="link text-warning"  onclick="return confirm('Are you sure you want to approve request?')" data-bs-toggle="tooltip" data-bs-placement="left" title="Click to initiate transfer" href="{{ route('admin.initiateTransfer', base64_encode($transfer->delivery_number)) }}" > <span class="fa-solid fa-toggle-off"></span></a>
                                                @elseif($transfer->status == 1 )
                                                    <a class="link text-success" data-bs-toggle="tooltip" data-bs-placement="left" title="Transfer approved, release transfer"  onclick="return confirm('Are you sure you want to release teas for this request?')" href="{{ route('admin.serviceRequest', base64_encode($transfer->delivery_number)) }}"> <span class="fa-solid fa-retweet"></span> </a>
                                                @elseif($transfer->status == 2)
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end border py-0">
                                                <div class="py-2">
                                                    @if($id == 5)
                                                        ...
                                                        <a class="dropdown-item text-primary" href="{{ route('admin.downloadInterDelNote', base64_encode($transfer->delivery_number)) }}">Download Transfer</a>
