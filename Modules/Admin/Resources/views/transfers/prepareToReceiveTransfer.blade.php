                    ...
                    <form method="POST" id="myForm" action="{{ route('admin.receiveInterTransferRequest', base64_encode($transfers[0]->delivery_number)) }}">
                            ...
                            @foreach($transfers as $transfer)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="number" step="0.1" name="deliveries[{{ $transfer->transfer_id }}][palette]" class="form-control form-select-sm" max="{{ $transfer->requested_palettes }}" id="tPackages">
                                    </td>
                                    <td>
                                        <input id="currentWeight" type="hidden" value="{{ $transfer->requested_weight }}">
                                        <input type="number" step="0.01" name="deliveries[{{ $transfer->transfer_id }}][weight]" class="form-control form-select-sm" max="{{ $transfer->requested_weight }}" readonly id="tWeight">
                        ...
                        <div class="row row-cols-sm-3 g-2">
                            ...
                            <div class="mb-2">
                                ...
                                <input class="form-control" value="{{ $transfer->registration }}" name="registration" id="editableSelect" type="text" list="optionsList" placeholder="-- plate number --" style="height: 62% !important;">
                            ...
                            <div class="mb-2">
                                ...
                                <input id="idSelect" type="text" value="{{ $transfer->id_number }}" list="idList" name="idNumber" class="form-control idSelect" placeholder="-- driver's ID Number --" style="height: 62% !important;">
                                <datalist id="idList">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="driverName" value="{{ $transfer->driver_name }}" id="driverName" class="form-control driverName" style="height: 54% !important;">
                            </div>

                            <div class="mb-4">
                                <label class="my-1 fs-xs fw-bold" style="font-size: 85% !important;">DRIVER'S PHONE NUMBER</label>
                                <input type="text" name="driverPhone" value="{{ $transfer->phone }}" id="driverPhone" class="form-control driverPhone" style="height: 74% !important;">
                            </div>
