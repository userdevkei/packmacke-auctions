...
<table class="table">
    ...
    ?>
        @foreach($statements as $statement)
            ...
            <td>{{ $statement->transaction_date == null || $statement->transaction_date == '--'  ? '--' : \Carbon\Carbon::createFromTimestamp($statement->transaction_date, config('app.timezone'))->format('d-m-Y') }} </td>
