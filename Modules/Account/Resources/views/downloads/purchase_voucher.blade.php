...
<table class="table no-border">
    <tbody class="no-border">
        ...
        <tr class="no-border">
            ...
            <td class="no-border">{{ \Carbon\Carbon::createFromTimestamp($values->date_invoiced, config('app.timezone'))->format('d-m-Y') }}</td>
            <td class="no-border">{{ \Carbon\Carbon::createFromTimestamp($values->due_date, config('app.timezone'))->format('d-m-Y') }}</td>
        </tr>
    </tbody>
</table>
<hr>
...
<p class="right-align">
    <span class="bold">INVOICE TO BE PAID BY OR BEFORE, </span> {{ \Carbon\Carbon::createFromTimestamp($values->due_date, config('app.timezone'))->format('D, d/m/Y') }}
</p>
</body>
</html>
