        ...
        <div class="card-body overflow-hidden p-lg-3">
            <div class="row align-items-center">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c3976e0e-38db-410e-861a-36d04a3a7494" id="dom-c3976e0e-38db-410e-861a-36d04a3a7494">
                    <form method="POST" action="{{ route('clerk.updateBlend', $sheet->blend_id) }}">
                        @csrf
                        <div class="row g-2 needs-validation" novalidate="">
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <input class="form-control" value="{{ $sheet->garden }}"  type="text" name="gardenName" placeholder="provide garden name" style="height: 45% !important;"/>
                            </div>

                            <div class="col-md-4 mb-1">
                                <label >GRADE NAME</label>
                                <input class="form-control" value="{{ $sheet->grade }}" type="text" name="blendGrade" placeholder="provide grade name" style="height: 45% !important;"/>
                            </div>
