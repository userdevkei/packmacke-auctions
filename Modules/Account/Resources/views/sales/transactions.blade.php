                    ...
                    <table class="table mb-0 table-bordered table-striped" id="datatable">
                        ...
                        @foreach($transactions as $invoice)
                            <tr>
                                ...
                                <td> {{ \Carbon\Carbon::createFromTimestamp($invoice->date_received, config('app.timezone'))->format('D, d/m/y') }} </td>
                                <td>
                                    ...
                                    |
                                        <a href="#"
                                           ...
                                           data-date="{{ \Carbon\Carbon::createFromTimestamp($invoice->date_received, config('app.timezone'))->format('Y-m-d') }}"
