...
@section('account::dashboard')
    ...
    <div class="row row-cols-sm-3 g-1 mb-2">
        ...
        <div>
            ...
            <input type="date" name="invoiceDate" class="form-control invoiceDate" id="invoiceDate" value="{{ \Carbon\Carbon::createFromTimestamp($invoice[0]->date_invoiced, config('app.timezone'))->format('Y-m-d') }}" style="height: 62% !important;">
        </div>
        <div>
            <label for="dueDate" class="form-label fs-6 fw-bold" style="font-size: 85% !important;">INVOICE DUE DATE</label>
            <input type="date" name="dueDate" class="form-control dueDate" id="dueDate" value="{{ \Carbon\Carbon::createFromTimestamp($invoice[0]->due_date, config('app.timezone'))->format('Y-m-d') }}" style="height: 62% !important;">
        </div>
    </div>
