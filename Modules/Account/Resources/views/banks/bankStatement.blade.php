                    ...
                    <table class="table mb-0 table-bordered table-striped" id="datatable">
                        ...
                        @foreach($statements as $statement)
                            <tr>
                                ...
                                <td><input type="date" class="form-control form-control-sm date-input" value="{{ $statement->bank_date ? Carbon\Carbon::createFromTimestamp($statement->bank_date, config('app.timezone'))->format('Y-m-d') : '' }}" data-id="{{ $statement->transaction_id }}"></td>
                            </tr>
                          @endforeach
                        </tbody>
                    </table>
