...
{{--    <meta name="csrf-token" content="{{ csrf_token() }}">--}}
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title> {{ config('app.name') }} | Accounts Dashboard </title>
    <style>
        body {
    ...
    <main class="main" id="top">
      <div class="container-fluid" data-layout="container-fluid">
        <script>
          ...
          // Get the table
          const table = document.querySelector('.tab-pane .table');

          // Get the number of columns dynamically
          // const columnCount = table.querySelectorAll('th').length;
          const columnCount = table.querySelectorAll('td').length;

          // Set the CSS variable for column count
        ...
        <script>
            ...
            function loadNotifications() {
                fetch(`{{ route('accounts.notifications') }}`)
                    .then(res => res.json())
                    .then(data => {
            ...
            document.addEventListener('click', function(e) {
                ...
                fetch('accounts/notifications/' + id)
                    .then(res => res.json())
                    .then(data => {
