                ...
                <div class="col-6 col-sm-auto ms-auto text-end ps-0">
                    ...
                    <form method="post" class="m-0">
                        ...
                        <button class="btn btn-falcon-default btn-sm" type="submit" formtarget="_blank">
                            ...
                            <input type="hidden" name="from" value="{{ Carbon\Carbon::createFromTimestamp($from, config('app.timezone'))->format('Y-m-d') }}">
                            <input type="hidden" name="to" value="{{ Carbon\Carbon::createFromTimestamp($to, config('app.timezone'))->format('Y-m-d') }}">
