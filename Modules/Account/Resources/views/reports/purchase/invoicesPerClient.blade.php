                        ...
                        @foreach($invoices as $accountNumber => $accounts)
                            @foreach($accounts as $currency => $invoice)
                                <tr>
                                    ...
                                    <td> {{ \Carbon\Carbon::createFromTimestamp($invoice[0]['date_invoiced'], config('app.timezone'))->format('D, d/m/y') }} </td>
                                    <td> {{ \Carbon\Carbon::createFromTimestamp($invoice[0]['due_date'], config('app.timezone'))->format('D, d/m/y') }} </td>
                                    <td>
