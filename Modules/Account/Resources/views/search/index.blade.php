                                    ...
                                    <table class="table mb-0 table-striped table-bordered fs-sm datatable">
                                        ...
                                        @foreach($sales as $invoice)
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::createFromTimestamp($invoice->date_invoiced, config('app.timezone'))->format('d-m-Y') }}</td>
                                                <td>
                                    ...
                                    <table class="table mb-0 table-striped table-bordered fs-sm datatable">
                                        ...
                                        @foreach($receipts as $receipt)
                                            <tr>
                                                ...
                                                <td>{{ Carbon\Carbon::createFromTimestamp($receipt->date_received, config('app.timezone'))->format('d-m-Y') }}</td>
                                                <td>
                                    ...
                                    <table class="table mb-0 table-striped table-bordered fs-sm datatable">
                                        ...
                                        @foreach($payments as $payment)
                                            <tr>
                                                ...
                                                <td>{{ Carbon\Carbon::createFromTimestamp($payment->date_received, config('app.timezone'))->format('d-m-Y') }}</td>
                                                <td>
                                                    <a class="link text-success" data-bs-toggle="tooltip"
                                                       data-bs-placement="left" title="Download Payment Voucher"
