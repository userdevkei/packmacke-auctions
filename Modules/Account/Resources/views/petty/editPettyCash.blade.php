                            ...
                            <div class="invoice-header">
                                <div class="row row-cols-sm-3 g-2 mb-3">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="date" value="{{ \Carbon\Carbon::createFromTimestamp($petty->date_invoiced, config('app.timezone'))->format('Y-m-d') }}" class="form-control" name="paymentDate" style="height: 60% !important;">
                                    </div>
                                </div>
