                                ...
                                <td>
                                    ...
                                    <div class="dropdown font-sans-serif position-static" >
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-0">
                                            <div class="py-2">
                                                <a class="dropdown-item text-info" href="{{ route('clerk.viewLocationPendingTCIs', $tci->location_id) }}">View Location</a>
                                                <a class="dropdown-item text-primary" href="{{ route('clerk.downloadLocationPendingTCIs',  base64_encode($tci->location_id.':'.'1')) }}" target="_blank">Download PDF</a>
                                                <a class="dropdown-item text-secondary" href="{{ route('clerk.downloadLocationPendingTCIs', base64_encode($tci->location_id.':'.'2')) }}">Download Excel</a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
