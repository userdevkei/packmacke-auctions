                                    ...
                                    <div class="col-sm-6 col-md-5">
                                        <div class="d-flex position-relative">
                                            ...
                                            <div class="flex-1"><a class="stretched-link text-800" href="#!">
                                                ...
                                                <p class="mb-0 fs-11 text-500">{{ ucwords(strtolower(auth()->user()->station->location->location_name)) }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-5">
                                        <div class="d-flex position-relative">
                                            ...
                                            <div class="flex-1"><a class="stretched-link text-800" href="#!">
                                                ...
                                                <p class="mb-0 fs-11 text-500">{{ ucwords(strtolower(auth()->user()->station->station_name)) }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
