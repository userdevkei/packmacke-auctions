                ...
                <div class="tab-pane preview-tab-pane active" role="tabpanel"
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($teaDetails['blendUsage'] as $blend)
                                            ...
                                            <span
                                                ...
                                                {{ $blend->status }}  {{ $blend->blend_shipped == null ? '' : \Carbon\Carbon::createFromTimestamp($blend->blend_shipped, config('app.timezone'))->format('Y-m-d') }}
                                            </span>
                                                </td>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($teaDetails['buyers'] as $sample)
                                            <tr>
                                                ...
                                                <td>{{ $sample->delivery_number }}</td>
                                                <td>{{ $sample->client_name }}</td>
                                                <td>{{ number_format($sample->transferred_palettes, 0) }}</td>
                                                <td>{{ number_format($sample->transferred_weight, 2) }}</td>
                    ...
                    @if($teaDetails['stockDetails'] && count($teaDetails['stockDetails']) > 0)
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($teaDetails['stockDetails'] as $stock)
                                            <tr>
                                                ...
                                                <td>{{ number_format($stock->current_packages, 0) }}</td>
                                                <td>{{ number_format($stock->current_weight, 2) }}</td>
                                                <td>{{ $stock->blend_date }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                @php
                                    $currentStock = DB::table('blendBalances')
                                        ->where('blend_id', $id)
                                        ->where('current_packages', '>', 0)
                                        ->where('current_weight', '>', 0)
                                        ->selectRaw('SUM(current_packages) as stockAtHand')
