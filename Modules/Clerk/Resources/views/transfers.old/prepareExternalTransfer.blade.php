        ...
        <div class="card-body overflow-hidden p-lg-3">
            <div class="row align-items-center">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c3976e0e-38db-410e-861a-36d04a3a7494" id="dom-c3976e0e-38db-410e-861a-36d04a3a7494">
                    <form method="POST" id="myForm" action="{{ route('clerk.registerExternalRequest') }}">
                        @csrf
                            ...
                            @foreach($transfers as $transfer)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="number" step="0.01" name="deliveries[{{ $transfer->stock_id }}][weight]" class="form-control weight-input form-control-sm" max="{{ $transfer->current_weight }}"
                                               @if($transfer->type === 1) readonly @endif  id="tWeight">
                                    </td>
                                    <td>
