        ...
        <div class="card-body overflow-hidden p-lg-3">
            <div class="row align-items-center">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c3976e0e-38db-410e-861a-36d04a3a7494" id="dom-c3976e0e-38db-410e-861a-36d04a3a7494">
                    <form method="POST" class="needs-validation" novalidate="" action="{{ route('clerk.addBlendSheet') }}">
                        @csrf
                        <div class="row g-2">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control"  type="text" name="gardenName" placeholder="provide garden name" style="height: 58% !important;"/>
                            </div>

                            <div class="col-md-4 mb-2">
                                <label for="floatingInputValid">GRADE NAME</label>
                                <input class="form-control"  type="text" name="blendGrade" placeholder="provide grade name" style="height: 58% !important;"/>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control"  type="text" name="shipmentNumber" placeholder="provide blend number" style="height: 58% !important;"/>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control"  type="text" name="contract" placeholder="provide contract number" style="height: 58% !important;"/>
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input class="form-control" id="totalWeight" type="text" name="consignee" placeholder="provide consignee" style="height: 58% !important;"/>
                            </div>
