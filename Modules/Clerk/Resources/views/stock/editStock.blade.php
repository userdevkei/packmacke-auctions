    ...
    <div class="card">
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-0 py-xl-0">Update {{ $order->invoice_number }} ({{ $order->client_name }}) </h5>
                </div>
        ...
        <div class="card-body overflow-hidden p-lg-3">
            <div class="row align-items-center">
                <form id="tciForm" method="post" action="{{ route('clerk.updatedStock', $order->stock_id) }}">
                    @csrf
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c3976e0e-38db-410e-861a-36d04a3a7494" id="dom-c3976e0e-38db-410e-861a-36d04a3a7494">
                        <fieldset class="border p-2">
                            <legend class="float-none w-auto fw-bold" style="font-size: 120% !important;">Tea Details</legend>
                            <div class="row row-cols-sm-3 g-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="numberPackages" id="numberPackages" class="form-control  numberPackages" value="{{ $order->total_pallets }}" placeholder="--" required/>
                                </div>

                                <div class="mb-2">
                                    <label class="my-1 fs-xs fw-bold" style="font-size: 85% !important;">TEA NET WEIGHT (DO WEIGHT)</label>
                                    <input type="number" name="total_weight" id="totalWeight" value="{{ $order->net_weight }}" class="form-control  totalWeight" placeholder="--" required/>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" readonly required min="0" name="netWeight" value="{{ $order->total_weight == null ? ' ': $order->total_weight }}" id="netWeight" placeholder="--" class="form-control  netWeight">
                                </div>

                                    <div class="mb-2">
                                        <label class="my-1 fs-xs fw-bold" style="font-size: 85% !important;">DELIVERY NUMBER</label>
                                        <input type="text" class="form-control " name="delivery_number" placeholder="---" value="{{ $order->delivery_number }}">
                                    </div>
                                    <div class="col-4">
                                        <label class="my-1 fs-xs fw-bold" style="font-size: 85% !important;">PHML WAREHOUSES</label>
                                        <select name="station" class="form-control  js-choice" id="recStation" required data-options='{"removeItemButton":true,"placeholder":true}'>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <select name="bay" class="form-control " id="selectedBay" required>
                        ...
                        <div class="mt-4">
                            <fieldset class="border p-2">
                                <legend class="float-none w-auto fw-bold" style="font-size: 120% !important;">Transport Details</legend>
                                <div class="row">
                                    ...
                                    <div class="col-4 mb-2">
                                        ...
                                        <input class="form-control " value="{{ $order->registration }}" name="registration" id="editableSelect" type="text" list="optionsList" placeholder="-- vehicle registration number --" >
                                    ...
                                    <div class="col-4 mb-2">
                                        ...
                                        <input id="idSelect" type="text" value="{{ $order->id_number }}" list="idList" name="idNumber" class="form-control  idSelect" placeholder="-- driver's ID Number --" >
                                        <datalist id="idList">
                                    ...
                                    <div class="col-4 mb-2">
                                        ...
                                        <input type="text" value="{{ $order->driver_name }}" name="driverName" id="driverName" class="form-control  driverName">
                                    </div>
                                    <div class="col-4 mb-4">
                                        <label class="my-1 fs-xs fw-bold" style="font-size: 85% !important;">DRIVER'S PHONE NUMBER</label>
                                        <input type="text" value="{{ $order->phone }}" name="driverPhone" id="driverPhone" class="form-control  driverPhone" >
                                    </div>
                                    <div class="col-4 mb-4">
                                        <label class="my-1 fs-xs fw-bold" style="font-size: 85% !important;">DATE RECEIVED</label>
                                        <input type="date" class="form-control " name="date_received" value="{{ Carbon\Carbon::parse($order->stock_date)->format('Y-m-d') }}">
                                    </div>
                                </div>
                            </fieldset>
