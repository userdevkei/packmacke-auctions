            ...
            <div class="row flex-between-center">
                ...
                <div class="col-6 col-sm-auto ms-auto text-end ps-0">
                    <div id="table-simple-pagination-replace-element">
                        @if(auth()->user()->role_id == 3 || @canuser('stocks.receive'))
                    ...
                    <div class="modal-dialog modal-xl mt-6" role="document">
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                ...
                                <div class="p-4">
                                    <form method="post" action="{{ route('clerk.StockReport') }}" target="_blank">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-6 mb-2">
                                                ...
                                                <select class="form-select js-choice" name="station">
                                                    ...
                                                    @foreach($stocks->groupBy('station_id') as $stationId => $groupedStation)
                                                        <option value="{{ $stationId }}">
                                                            {{ $groupedStation->first()->stocked_at ?? 'Unknown Station' }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        @if(auth()->user()->role_id == 2 || @canuser('export.stock-excel'))
                    ...
                    <table class="table mb-0 table-bordered table-striped" id="datatable">
                        ...
                        @foreach($stocks as $stock)
                            <tr class="clickable-row cursor-pointer parent-row" data-stock-id="{{ $stock->stock_id }}">
                                ...
                                <td nowrap="">{{ \Carbon\Carbon::createFromTimestamp($stock->date_received, config('app.timezone'))->format('d/m/Y') }}</td>
                                ...
                                <td nowrap="">
                                    <div class="dropdown font-sans-serif position-static">
                                        <a class="link text-info mx-1" href="{{ route('clerk.traceTea', $stock->delivery_id) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="Trace Tea">
                                            <span class="fa fa-info"></span>
                                        </a>
                                        @if(auth()->user()->role_id == 2 || @canuser('stock-item.edit'))
                                        ...
                                        <a class="link text-danger mx-1" href="{{ route('clerk.editStock', $stock->stock_id) }}" data-bs-toggle="tooltip" data-bs-placement="left" title="Edit Tea"><span class="fa fa-pen"></span> </a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
