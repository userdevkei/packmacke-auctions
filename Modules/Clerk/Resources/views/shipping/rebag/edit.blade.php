        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-0 py-xl-0">Edit Rebag Job No. {{ $sheet->blend_number }} </h5>
                </div>
            </div>
        </div>
        <div class="card-body overflow-hidden p-lg-3">
            <div class="row align-items-center">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c3976e0e-38db-410e-861a-36d04a3a7494" id="dom-c3976e0e-38db-410e-861a-36d04a3a7494">
                    <form method="POST" class="needs-validation" novalidate="" action="{{ route('clerk.updateRebag', $sheet->blend_id) }}">
                        @csrf
                        <div class="row g-2" >
                            ...
                            <div class="col-md-4 mb-1">
                                <label for="floatingInputValid">REBAG JOB NUMBER (PARENT)</label>
                            ...
                            <div class="col-md-4 mb-1">
                                <label >REBAG JOB NUMBER</label>
                                <input class="form-control" value="{{ $sheet->blend_number }}" type="text" name="shipmentNumber" placeholder="provide SI number" style="height: 58% !important;"/>
                            </div>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-md btn-success col-6">UPDATE REBAG JOB SHEET</button>
                        </div>
                    </form>
                </div>
            </div>
