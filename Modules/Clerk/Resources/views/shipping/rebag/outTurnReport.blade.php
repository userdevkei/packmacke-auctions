        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-0 py-xl-0">Update Rebag Job Number {{ $bs->blend_number }} ({{ $bs->client_name }}) </h5>
                </div>
            </div>
        </div>
        <div class="card-body overflow-hidden p-lg-3">
            <div class="row align-items-center">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c3976e0e-38db-410e-861a-36d04a3a7494" id="dom-c3976e0e-38db-410e-861a-36d04a3a7494">
                    <form method="POST" action="{{ route('clerk.updateRebagJobDetails', $bs->blend_id) }}">
                        @csrf
                        <div class="row row-cols-sm-2 g-2">
                            <fieldset class="border py-2">
                                <legend class="float-none fw-bolder w-auto p-2 h6">REBAG OUTTURN </legend>
                                ...
                                <div class="mb-2 mx-2 my-3">
                                    <span class="h6 fs-xs  m-2" style="font-size: 95% !important;">REBAGGED TEA PACKAGING </span>
                                </div>

                                <div class="row mb-4 mx-2 mt-3">
                                    <div class="col-md-6">
                                        <span class="h6 fs-xs  m-2" style="font-size: 95% !important;">REBAG PHASES INVOLVED</span>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row mb-2 mx-2 my-3">
                                    <div class="col-md-6">
                                        <span class="h6 fs-xs  m-2" style="font-size: 95% !important;">REBAG BALANCE PACKAGES </span>
                                    </div>
                                ...
                                <div class="row mb-2 mx-2">
                                    <div class="col-md-6">
                                        <span class="h6 fs-xs " style="font-size: 95% !important;">TOTAL REBAG BALANCE </span>
                                    </div>
                            ...
                            <fieldset class="border py-2">
                                <legend class="float-none w-auto fw-bolder p-2 h6">REBAG OUTTURN </legend>
                                <div class="row mb-2 mx-2 my-3">
                                    <div class="col-md-6">
                        ...
                        <fieldset class="border py-2">
                            <legend class="float-none w-auto p-2 h6 fw-bolder">PACKAGING</legend>
                            <div class="row row-cols-sm-2 g-2 mx-1">
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    <label class="my-1 fs-xs" style="font-size: 85% !important;">REBAG DATE <sup class="text-danger">*</sup></label>
                                    <input type="date" name="blendDate" class="form-control" required value="{{ $outTurnReport['blend_date'] ? \Carbon\Carbon::parse($outTurnReport['blend_date'])->format('Y-m-d') : '' }}">
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <button id="submitBtn" type="button" class="btn btn-success">UPDATE REBAG DETAILS</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    document.addEventListener('click', function (e) {
        var btn = e.target.closest('#submitBtn');
        if (!btn) return;

        console.log('submitBtn clicked'); // should always log if delegation is working

        e.preventDefault();

        var form = btn.closest('form');
        if (!form) {
            console.error('No parent <form> found for submitBtn');
            return;
        }
