...
<table class="table">
    ...
    ?>
        @foreach($orders as $order)
            ...
            <td>{{ $order->date_received ? Carbon\Carbon::createFromTimestamp($order->date_received, config('app.timezone'))->format('Y-m-d') : Carbon\Carbon::parse($order->blend_date)->format('Y-m-d') }}</td>
            </tr>
            <?php
