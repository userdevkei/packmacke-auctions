                        ...
                        <table class="table mb-0 table-bordered table-striped" id="datatable">
                            ...
                            @foreach($transfers as $transfer)
                                <tr>
                                    ...
                                    <td>
                                        <input @if($transfer->status <= 3) disabled @endif class="release-checkbox" data-id="{{ $transfer->ex_transfer_id }}" @if($transfer->release_date) checked @else @endif type="checkbox" value="{{ $transfer->ex_transfer_id }}">
                                    </td>
