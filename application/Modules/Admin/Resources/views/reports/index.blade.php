                        ...
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                ...
                                <div class="p-4">
                                    ...
                                    <form class="needs-validation" novalidate method="POST" action="{{ route('admin.storeReport') }}">
                                        @csrf
                                        <div class="row row-cols-sm-3 g-2">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select name="client_id" id="clientId" class="form-select js-choice" required style="height: 61% !important;">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select name="priority" class="form-select js-choice" required>
                                                    <option disabled selected value="">-- select priority type --</option>
                    ...
                    <table class="table mb-0 table-bordered table-striped" id="datatable">
                        ...
                        @foreach($requests as $request)
                            <tr>
                                ...
                                <td nowrap="">
                                        @if($request->status == 0)
                                            <a class="text-warning mx-1" data-bs-toggle="tooltip" data-bs-placement="left" title="Approve Report Request" onclick="return confirm('Are you sure you want to approve this report request?')" href="{{ route('admin.approveReportRequest', $request->request_id) }}">
                                         <span class="fa-regular fa-thumbs-up"></span> </a>
                                        @else
                                            <a class="text-success mx-1" data-bs-toggle="tooltip" data-bs-placement="left" title="Report Request Approved"> <span class="fa fa-check-double"></span> </a>
                                        @endif

                                        <a class="text-danger mx-1" data-bs-toggle="tooltip" data-bs-placement="left" title="Delete this report request" onclick="return confirm('Are you sure you want to delete selected report request?')" href="{{ route('admin.deleteReportRequest', $request->request_id) }}"><span class="fa fa-trash-alt"></span></a>
                                        <a class="text-dark" aria-expanded="false" data-bs-toggle="tooltip" title="Download Report Request" href="{{ route('admin.downloadReportRequest', $request->request_id) }}" target="_blank"> <span class="fa fa-cloud-download-alt"> </span> </a>
