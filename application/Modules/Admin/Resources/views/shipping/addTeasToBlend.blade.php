            ...
            <div class="modal-dialog modal-xl mt-6" role="document">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-0">
                        ...
                        <div class="p-4">
                            <form id="shippingForm" method="POST" action="{{ route('admin.storeBlendTeas', $bs->blend_id) }}">
                                @csrf
            ...
            <div class="modal-dialog modal-xl mt-6" role="document">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-0">
                        ...
                        <div class="p-4">
                            <form id="shippingForm" method="POST" action="{{ route('admin.addBlendBalanceTeas', $bs->blend_id) }}">
                                @csrf
                        ...
                        <table class="table mb-0 table-bordered table-striped" id="datatable">
                            ...
                            @foreach($teas as $shipping)
                                ...
                                <tr>
                                    ...
                                    @if($bs->status < 4)
                                    <td>
                                        <a class="link-danger" data-bs-toggle="tooltip" data-bs-placement="left" title="Remove line from Blendsheet" onclick="return confirm('Are you sure you want to remove selected line from the SI?')" href="{{ route('admin.deleteBlendTea', $shipping->blended_id) }}"><span class="fa fa-trash-alt"></span></a>
                                    </td>
                                    @endif
                                </tr>
