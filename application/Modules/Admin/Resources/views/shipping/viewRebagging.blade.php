                ...
                <div class="modal-dialog modal-xl mt-2" role="document">
                    <div class="modal-content border-0">
                        ...
                        <div class="modal-body p-0">
                            ...
                            <div class="p-4">
                                <form method="POST" id="myForm" action="{{ route('admin.storeRebaggingRequest', $data->shipping_id ?? $data->blend_id) }}">
                                    @csrf
                    ...
                    <table class="table mb-0 table-bordered fs-sm table-sm table-striped datatable" id="datatable">
                        ...
                        @foreach($lines as $transfer)
                            <tr>
                                ...
                                <td>
                                    <a class="link link-danger" href="{{ route('clerk.removeRebaggedTea', $transfer->rebagging_id) }}" onclick="return confirm('Are you sure you want remove selected line?')"><i class="fa fa-trash-alt"></i> </a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
