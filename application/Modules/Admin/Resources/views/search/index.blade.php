                                    ...
                                    <table class="table mb-0 table-striped table-bordered fs-sm datatable">
                                        ...
                                        @foreach($teas as $tea)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="link-info" href="{{ route('admin.traceTea', $tea->delivery_id) }}"><i class="fa fa-info"></i> view tea</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    ...
                                    <table class="table mb-0 table-striped table-bordered fs-sm datatable">
                                        ...
                                        @foreach($blends as $blend)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="link-info" href="{{ route('admin.addBlendTeas', $blend->blend_id) }}">View</a> |
                                                    <a class="link-primary" href="{{ route('admin.downloadBlendSheet', $blend->blend_id) }}" target="_blank">Download Bs</a> |
                                                    <a class="link-dark {{ $blend->status < 3 ? 'disabled text-muted' : '' }}"
                                                       href="{{ $blend->status >= 3 ? route('admin.downloadOutturReport', $blend->blend_id) : '#' }}"
                                                       @if($blend->status < 3) onclick="return false;" @endif
                                                       target="_blank" > Download Outturn </a> |
                                                    <a class="link-secondary" href="{{ route('admin.downloadBlendDriverClearance', $blend->blend_id) }}" target="_blank"> Port Clearance</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    ...
                                    <table class="table mb-0 table-striped table-bordered fs-sm datatable">
                                        ...
                                        @foreach($straightLine as $straight)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="link-info" href="{{ route('admin.addShipmentTeas', $straight->shipping_id) }}">View SI</a> |
                                                    <a class="link-primary" href="{{ route('admin.downloadSIDocument', $straight->shipping_id) }}" target="_blank">Download SI</a> |
                                                    <a class="link-dark" href="{{ route('admin.downloadDriverClearance', $straight->shipping_id) }}" target="_blank"> Driver Clearance</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    ...
                                    <table class="table mb-0 table-striped table-bordered fs-sm datatable">
                                        ...
                                        @foreach($blendBalances as $blendBalance)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="link-info" href="{{ route('admin.traceBlendBalance', $blendBalance->blend_id) }}"><i class="fa fa-info"></i> view tea</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    ...
                                    <table class="table mb-0 table-striped table-bordered fs-sm datatable">
                                        ...
                                        @foreach($internalTransfers as $internalTransfer)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="link-info" href="{{ route('admin.viewInternalTransferDetails', base64_encode($internalTransfer->delivery_number)) }}">View Transfer</a> |
                                                    <a class="link-primary" href="{{ route('admin.downloadInterDelNote', base64_encode($internalTransfer->delivery_number)) }}" target="_blank">Download Transfer</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                        ...
                                        <table class="table mb-0 table-striped table-bordered fs-sm datatable">
                                            ...
                                            @foreach($externalTransfers as $externalTransfer)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="link-info" href="{{ route('admin.viewExternalTransferDetails', base64_encode($externalTransfer->delivery_number)) }}">View Transfer</a> |
                                                        <a class="link-primary" href="{{ route('admin.downloadExtraDelNote', base64_encode($externalTransfer->delivery_number)) }}" target="_blank">Download Transfer</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        ...
                                        <table class="table mb-0 table-striped table-bordered fs-sm datatable">
                                            ...
                                            @foreach($tcis as $tci)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="dropdown font-sans-serif position-static" >
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end border py-0">
                                                                <div class="py-2">
                                                                    <a class="dropdown-item text-info" href="{{ route('admin.viewTciDetails', base64_encode($tci->loading_number)) }}">View TCI</a>
                                                                    <a class="dropdown-item text-warning" href="{{ route('admin.amendTciDetails', base64_encode($tci->loading_number)) }}">Amend TCI</a>
                                                                    <a class="dropdown-item text-dark" href="{{ route('admin.downloadLLI', base64_encode($tci->loading_number.':'.'1')) }}" target="_blank">Download PDF </a>
                                                                    <a class="dropdown-item text-secondary" href="{{ route('admin.downloadLLI', base64_encode($tci->loading_number.':'.'2')) }}" target="_blank">Download Excel </a>
                                                                    @if($tci->status < 2)
                                                                        <a class="dropdown-item text-danger" onclick="return confirm('Are you sure you want to delete TCI NO. {{ $tci->loading_number }}?')" href="{{ route('admin.revertTCI', base64_encode($tci->loading_number)) }}">Delete DO</a>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </span>
