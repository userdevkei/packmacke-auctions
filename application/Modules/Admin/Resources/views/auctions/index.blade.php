        ...
        <div class="card-header">
            <div class="row flex-between-center">
                <div class="col-6 col-sm-auto d-flex align-items-center pe-0">
                    <h5 class="fs-9 mb-0 text-nowrap py-0 py-xl-0">Auction Teas</h5>
                </div>
                    ...
                    <div class="modal-dialog modal-md mt-6" role="document">
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                ...
                                <div class="p-4">
                                    <form class="needs-validation" novalidate method="POST" id="myForm" action="{{ route('admin.prepareAuctionList') }}">
                                        @csrf
                    ...
                    <table class="table mb-0 table-bordered table-responsive table-striped fs-sm " id="datatable">
                        ...
                        @foreach($auctions as $transfer)
                            <tr>
                                ...
                                <td>{{ $transfer->sale }}</td>
                                <td>
                                    <a class="link link-info" href="{{ route('admin.viewSale', base64_encode($transfer->sale)) }}">view sale</a> |
                                    <a class="link link-secondary" href="{{ route('admin.downloadAuctionSheet', base64_encode($transfer->sale.':'.'1')) }}" target="_blank"><i class="fa fa-file-pdf"></i> pdf</a> |
                                    <a class="link link-dark" href="{{ route('admin.downloadAuctionSheet', base64_encode($transfer->sale.':'.'2')) }}"><i class="fa fa-file-excel"></i> excel</a>
                                    |
                                    <a class="link link-danger" href="{{ route('admin.downloadAuctionSheetReport', base64_encode($transfer->sale)) }}" target="_blank"><i class="fa fa-file-pdf"></i> sale report</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
