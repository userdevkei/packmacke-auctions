...
<head>
    ...
    <title>PURCHASE ORDER #{{ $lpo->purchase_order_number }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <table class="header-table">
        <tr>
            ...
            <td style="width: 35%; vertical-align: middle; text-align: right;">
                ...
                <div class="po-number">#{{ $lpo->purchase_order_number }}</div>
                <br>
    ...
    <table class="info-table">
        <tr>
            <td class="info-box-left">
                ...
                <span class="info-value">{{ strtoupper($lpo->client->client_name) }}</span>
            ...
            <td class="info-box-right">
                ...
                <span class="info-value">
                    <span class="status-badge {{ strtolower($lpo->status) }}">{{ ucwords($lpo->status) }}</span>
                </span>
            </td>
        </tr>
    </table>
    ...
    <table class="items-table">
        ...
        @foreach ($lpo->items as $key => $item)
            <tr>
                ...
                <td>{{ $item->uom->item_name }}</td>
                <td class="text-center">{{ $item->uom->unit_label }}</td>
                <td class="text-right">{{ number_format($item->quantity, 2) }}</td>
            </tr>
        @endforeach
        <tr>
            <td colspan="4" class="text-right">
                Total Items - {{ $lpo->items->count() }}
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="signatures-table">
        <tr>
            <td>
                ...
                <br>
                <div class="signature-role">{{ $lpo->user->first_name.' '.$lpo->user->surname }}</div>
            </td>
            <td>
