            ...
            foreach ($records as $index => $record) {
                ...
                try {
                    ...
                    DeliveryOrder::create([
                        ...
                        'weight'          => $record['Actual Net Weight']/$record['Packages'],
                        'gross_weight'    => ($record['Actual Net Weight']/$record['Packages']) + $record['Package Tare'],
                        'total_weight'    => $record['Actual Net Weight'] + ($record['Packages']   * $record['Package Tare']) + $record['Pallete Weight'],
                    ...
                    StockIn::create([
                        ...
                        'net_weight'      => $record['Actual Net Weight']  ?? null,
                        'transporter_id'  => $transporter->transporter_id,
                        'driver_id'       => $driver->driver_id,
                        'registration'    => $request->registration,
                        'ra'              => $record['RA'] ?? null,
