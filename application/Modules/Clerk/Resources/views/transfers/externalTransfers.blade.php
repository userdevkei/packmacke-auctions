...
@section('clerk::dashboard')
    <div class="card">
                    ...
                    <div class="modal-dialog modal-xl mt-6" role="document">
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                ...
                                <div class="p-4">
                                    <form method="POST" id="myForm" action="{{ route('clerk.prepareExternalTransfer') }}">
                                        @csrf
                                        <div class="row row-cols-sm-2 g-2">
                                            ...
                                            @endphp
                                            <div class=" mb-4">
                                                <label class="fs-sm fw-bold my-2" style="font-size: 85% !important;"> WAREHOUSE </label>
                                            ...
                                            <div class=" mb-4">
                                                ...
                                                <select name="client" class="form-select" id="selectClients" style="height: 56% !important;">
        ...
        <div class="card-body overflow-hidden p-lg-3">
            <div class="">
                <form method="POST" action="{{ route('clerk.viewExternalTransfers') }}">
                    @csrf
