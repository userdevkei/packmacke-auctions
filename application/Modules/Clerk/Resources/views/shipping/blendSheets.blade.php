                                ...
                                <td nowrap="">
                                    <div class="d-flex align-items-center">
                                        @if($transfer->status == 0)
                                            @if(@canuser('blend.create') || $transfer->location_id == auth()->user()->station->location->location_id && auth()->user()->role_id == 3)
                                        ...
                                        @elseif($transfer->status == 1)
                                            @if($transfer->location_id == auth()->user()->station->location->location_id && auth()->user()->role_id == 3 || @canuser('blend.create'))
                                        ...
                                        <div class="dropdown font-sans-serif position-static" >
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end border py-0">
                                                <div class="py-2">
                                                    ...
                                                    @endif
                                                    @if(@canuser('blend.amendOutturn') && $transfer->status >= 2 && $transfer->status <= 4)
