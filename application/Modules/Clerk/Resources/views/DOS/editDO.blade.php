        ...
        <div class="card-body overflow-hidden p-lg-3">
            <div class="row align-items-center">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-c3976e0e-38db-410e-861a-36d04a3a7494" id="dom-c3976e0e-38db-410e-861a-36d04a3a7494">
                    <form id="doForm" method="POST" action="{{ route('clerk.updateDeliveryOrder', $order->delivery_id) }}">
                        @csrf
                        <div class="row g-2 needs-validation" novalidate="">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control" type="text" value="{{ $order->order_number }}" name="order_number" placeholder="provide do number" style="height: 61% !important;" />
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="floatingInputValid">INVOICE NUMBER</label>
                                <input class="form-control " type="text" value="{{ $order->invoice_number }}" name="invoice_number" placeholder="provide invoice number" style="height: 61% !important;" />
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control " type="number" value="{{ $order->weight }}" step="0.01" name="weight" placeholder="provide total net weight" style="height: 61% !important;" />
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input class="form-control " type="text" value="{{ $order->lot_number }}" name="lot_number" placeholder="provide total net weight" style="height: 61% !important;" />
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="floatingInputValid">SALE NUMBER</label>
                                <input class="form-control " type="text" value="{{ $order->sale_number }}" name="sale_number" placeholder="provide total net weight" style="height: 61% !important;" />
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="floatingInputValid">SALE DATE</label>
                                <input class="form-control " type="date" value="{{ $order->sale_date !== null ?? Carbon\Carbon::parse($order->sale_date)->format('Y-m-d') }}" name="sale_date" placeholder="provide total net weight" style="height: 61% !important;" />
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="floatingInputValid">PROMPT DATE</label>
                                <input class="form-control " value="{{ $order->prompt_date !== null ?? Carbon\Carbon::parse($order->prompt_date)->format('Y-m-d') }}" id="totalWeight" type="date" name="prompt_date" placeholder="provide total net weight" style="height: 61% !important;" />
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="floatingInputValid">PRODUCTION DATE</label>
                                <input class="form-control form-control-lg" value="{{ $order->production_date !== Carbon\Carbon::parse($order->production_date)->format('Y-m-d') }}" type="date" name="production_date" placeholder="provide total net weight" />
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="floatingInputValid">EXPIRY DATE</label>
                                <input class="form-control form-control-lg" value="{{ $order->expiry_date !== Carbon\Carbon::parse($order->expiry_date)->format('Y-m-d') }}" id="totalWeight" type="date" name="expiry_date" placeholder="provide total net weight" />
                            </div>
