...
{{--                                    <input type="text" class="form-control js-choice tag" name="containerNumbers" placeholder="Type a container number and press enter">--}}
                                    <input type="text" class="form-control js-choice tag" id="containerNumbers" name="containerNumbers" placeholder="Type a container number and press enter">
