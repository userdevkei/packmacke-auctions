...
class AdjustmentJournal extends Model
{
    ...
    protected $primaryKey = 'adjustment_journal_id';
    protected $keyType = 'string';
    protected $date = 'deleted_at';

    protected $fillable = ['adjustment_journal_id', 'reference_code', 'ledger_id', 'amount', 'description', 'date_adjusted', 'type', 'status', 'user_id', 'exchange_rate'];
...
//                ->whereNull('deleted_at')
    ...
    {
        return \Modules\Account\Database\factories\AdjustmentJournalFactory::new();
    }
}
