                    ...
                    <table class="table mb-0 table-bordered table-striped" id="datatable">
                        ...
                        @foreach($transfers as $transfer)
                            <tr>
                                ...
                                <td>
                                    {!! $transfer->status <= 2 ? '<span class="badge bg-info"> Pending Release <span>' : '<span class="badge bg-success"> Released <span>' !!}
                                </td>
                                <td nowrap="">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="dropdown font-sans-serif position-static" >
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end border py-0">
                                                <div class="py-2">
                                                    <a class="dropdown-item text-info" href="{{ route('client.viewExternalTransferDetails', base64_encode($transfer->delivery_number)) }}">View Transfer</a>
                                                    <a class="dropdown-item text-primary" href="{{ route('client.downloadExtraDelNote', base64_encode($transfer->delivery_number)) }}" target="_blank">Download Transfer</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
