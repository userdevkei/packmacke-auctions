...
class TraceTea
{
    public function traceDeliveryOrder($deliveryOrderId)
    {
        ...
        $stockDetails = DB::table('currentstock')
            ...
            ->select('delivery_number', 'stocked_at', 'gross_weight', 'bay_name', 'current_stock', 'current_weight', DB::raw("CONCAT(surname, ' ', first_name) AS created_by"), 'date_received')
