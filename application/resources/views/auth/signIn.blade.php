...
<head>
    ...
    <meta name="msapplication-TileImage" content="{{ url('assets/img/favicons/50x150.png') }}">
    <meta name="theme-color" content="#dff5df">
...
<main class="main" id="top">
    ...
    <div class="container-fluid">
        <div class="row min-vh-100 flex-center g-0">
            <div class="col-lg-8 col-xxl-5 py-3 position-relative"><img class="bg-auth-circle-shape" src="{{ url('assets/img/icons/spot-illustrations/bg-shape.png') }}" alt="" width="250"><img class="bg-auth-circle-shape-2" src="{{ url('assets/img/icons/spot-illustrations/shape-1.png') }}" alt="" width="150">
                <div class="card overflow-hidden z-1">
                    <div class="card-body p-0">
                        <div class="row g-0 h-100">
                            <div class="col-md-5 text-center bg-card-gradient">
                                <div class="position-relative p-4 pt-md-5 pb-md-7" data-bs-theme="light">
                                    <div class="bg-holder bg-auth-card-shape" style="background-image:url({{ url('assets/img/icons/spot-illustrations/half-circle.png') }});">
                                    </div>
                                    <!--/.bg-holder-->

                                    <div class="z-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-5 d-inline-block fw-bolder" href="{{ url('/') }}">{{ config('app.name') }}</a>
                                        <p class="opacity-75 text-white">Your Warehousing and Logistics Solution</p>
                                    </div>
                                </div>
                                ...
                                <div class="p-4 p-md-5 flex-grow-1">
                                    ...
                                    <form method="post" action="{{ route('auth.login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="password" class="form-control" id="card-password" type="password" />
                                        </div>
                                        <div class="row flex-between-center">
                                            <div class="col-auto">
...
{{--                                            <div class="col-auto"><a class="fs-10" href="../../../pages/authentication/card/forgot-password.html">Forgot Password?</a></div>--}}
                                        ...
                                        <div class="mb-3">
                                            <button class="btn btn-success d-block w-100 mt-3" type="submit" name="submit">Log in</button>
                                        </div>
                                    </form>
...
{{--                    <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherLight"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{ url('assets/img/generic/falcon-mode-default.jpg') }}" alt=""/></span><span class="label-text">Light</span></label>--}}
{{--                </div>--}}
{{--                <div class="col-4">--}}
{{--                    <input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio" value="dark" data-theme-control="theme" />--}}
{{--                    <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherDark"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{ url('assets/img/generic/falcon-mode-dark.jpg') }}" alt=""/></span><span class="label-text"> Dark</span></label>--}}
{{--                </div>--}}
{{--                <div class="col-4">--}}
{{--                    <input class="btn-check" id="themeSwitcherAuto" name="theme-color" type="radio" value="auto" data-theme-control="theme" />--}}
{{--                    <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherAuto"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="{{ url('assets/img/generic/falcon-mode-auto.jpg') }}" alt=""/></span><span class="label-text"> Auto</span></label>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--        <hr />--}}
...
{{--        <hr />--}}
{{--        <div class="d-flex justify-content-between">--}}
{{--            <div class="d-flex align-items-start"><img class="me-2" src="{{ url('assets/img/icons/arrows-h.svg') }}" width="20" alt="" />--}}
{{--                <div class="flex-1">--}}
...
{{--        </div>--}}
{{--        <hr />--}}
{{--        <div class="d-flex align-items-start"><img class="me-2" src="{{ url('assets/img/icons/paragraph.svg') }}" width="20" alt="" />--}}
{{--            <div class="flex-1">--}}
...
{{--                    <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-transparent"> <img class="img-fluid img-prototype" src="{{ url('/assets/img/generic/default.png') }}" alt="" /><span class="label-text"> Transparent</span></label>--}}
{{--                </div>--}}
{{--                <div class="col-6">--}}
{{--                    <input class="btn-check" id="navbar-style-inverted" type="radio" name="navbarStyle" value="inverted" data-theme-control="navbarStyle" />--}}
{{--                    <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-inverted"> <img class="img-fluid img-prototype" src="{{ url('assets/img/generic/inverted.png') }}" alt="" /><span class="label-text"> Inverted</span></label>--}}
{{--                </div>--}}
{{--                <div class="col-6">--}}
{{--                    <input class="btn-check" id="navbar-style-card" type="radio" name="navbarStyle" value="card" data-theme-control="navbarStyle" />--}}
{{--                    <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-card"> <img class="img-fluid img-prototype" src="{{ url('assets/img/generic/card.png') }}" alt="" /><span class="label-text"> Card</span></label>--}}
{{--                </div>--}}
{{--                <div class="col-6">--}}
{{--                    <input class="btn-check" id="navbar-style-vibrant" type="radio" name="navbarStyle" value="vibrant" data-theme-control="navbarStyle" />--}}
{{--                    <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-vibrant"> <img class="img-fluid img-prototype" src="{{ url('assets/img/generic/vibrant.png') }}" alt="" /><span class="label-text"> Vibrant</span></label>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
